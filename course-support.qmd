...
- **Software subscriptions:**
  ...
  - **SPSS:** This software is required for the course but can be accessed for free via college computers (e.g., in our classroom and library). If you choose to purchase the software for your personal computer, please see more information in the course syllabus under [course resources](course-syllabus.qmd).
